...
#                 minx + x * pixel_size, miny + y * pixel_size,
#                 minx + (x + tile_size_x) * pixel_size, miny + (y + tile_size_y) * pixel_size,
...
# # Open a sample tile
# with rasterio.open(r"C:\Users\Asus\Desktop\satellite\rondonia_tiles\tile_0_18176.tif") as src:
#     data = src.read(1)  # Read the first band
#     print("Min:", np.min(data), "Max:", np.max(data))  # Check if values are all zeros
# import rasterio
...
# plt.colorbar()
# plt.show()
# print("Number of Deforestation Pixels:", np.count_nonzero(data))
# plt.imshow(data, cmap="inferno")  # Or "jet", "viridis"
# plt.colorbar()
# plt.show()
import geopandas as gpd
import rasterio
